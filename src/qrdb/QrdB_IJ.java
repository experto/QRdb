 ...
 * @author expertoweb
 */
public class QrdB_IJ extends PlugInFrame {
    ...
    public void run(String arg) {  
        ...
        for (int i=1; i<=3; i++) {  
            ...
            if (img != null){
                ...
                dpnl.loadImage(image);                
                dpnl.repaint();
                
                ImageIcon icon = new ImageIcon(imageScaled, "My new image " + i);
    ...
    public void updateDir(String arg){
        ...
        for (int i = 0; i < listOfFiles.length; i++) 
        {
            ...
            if (listOfFiles[i] != null && 
                ...
                (listOfFiles[i].getName().endsWith(".tif") || listOfFiles[i].getName().endsWith(".JPG")))
            {
    ...
    private void initCustomComponents(){
                ...
                if (jTable1.getSelectedRow() > -1) {
                    ...
                    try{
                        ...
                        Image image = load(buffer.array());
                            // make sure that the image is not too big
                            //  scale with a width of 500 
                        //Image large = image.getScaledInstance(400, -1,  Image.SCALE_SMOOTH);
        ...
        MyButton jButton6 = new MyButton(new ImageIcon("resources/png/009.png").getImage());
        ...
        MyButton jButton7 = new MyButton(new ImageIcon("resources/png/010.png").getImage());
